...
/**
 * PATCH {baseUrl}/ads/{adId}/buy — mark an ad as purchased by the current
 * user. Body is empty; the backend derives the buyer from the auth token.
 * On success, wipes the cache so the ads list drops this ad and the
